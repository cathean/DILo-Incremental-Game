...
public class GameManager : MonoBehaviour
{
    ...
    public void CollectByTap(Vector3 tapPostition, Transform parent)
    {
        double output = 0;
        foreach(ResourceController resource in _activeResources)
        {
        ...
        tapText.transform.position = tapPostition;
    ...
    {
        TapText tapText = _tapTextPool.Find(transform => !transform.gameObject.activeSelf);
        if(tapText == null)
        {
